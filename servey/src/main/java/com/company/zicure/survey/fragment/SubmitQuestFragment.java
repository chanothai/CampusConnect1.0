...
public class SubmitQuestFragment extends Fragment implements View.OnClickListener{
    ...
    public void onClick(View view) {
        ...
        if (i == R.id.btn_submit) {
            Log.d("AnswerResponse", new GsonCart<PostQuestionnaire>(ModelCart.newInstance().getSerialized().questionnaire).getJsonStr());
            ClientHttp.newInstance(getActivity()).submitAnswerData();
